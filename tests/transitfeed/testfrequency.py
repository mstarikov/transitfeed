...
class FrequencyValidationTestCase(util.ValidationTestCase):
    def set_up(self):
        util.ValidationTestCase.set_up(self)
    ...
    def test_period_with_invalid_trip_id(self):
    ...
    def test_exact_times_string_value_conversion(self):
    ...
    def test_exact_times_as_int_value(self):
    ...
    def test_exact_times_invalid_values(self):
