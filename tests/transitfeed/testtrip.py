...
class TripMemoryZipTestCase(util.MemoryZipTestCase):
    def assert_load_and_check_extra_values(self, schedule_file):
        ...
        # Uncomment the following lines to print the string in test_extra_file_column
    ...
    def test_extra_file_column(self):
...
class TripValidationTestCase(util.ValidationTestCase):
    def run_test(self):
        ...
        # missing route ID
        trip.route_id = None
        self.ValidateAndexpect_missing_value(trip, 'route_id')
        trip.route_id = '054C'

        # missing service ID
        trip.service_id = None
        self.ValidateAndexpect_missing_value(trip, 'service_id')
        trip.service_id = 'WEEK'

        # missing trip ID
        trip.trip_id = None
        self.ValidateAndexpect_missing_value(trip, 'trip_id')
        trip.trip_id = '054C-00'

        # invalid direction ID
        trip.direction_id = 'NORTH'
        self.ValidateAndexpect_invalid_value(trip, 'direction_id')
        trip.direction_id = '0'

        # invalid bikes_allowed
        trip.bikes_allowed = '3'
        self.ValidateAndexpect_invalid_value(trip, 'bikes_allowed')
        trip.bikes_allowed = None

        # invalid wheelchair_accessible
        trip.wheelchair_accessible = '3'
        self.ValidateAndexpect_invalid_value(trip, 'wheelchair_accessible')
...
class TripServiceIDValidationTestCase(util.ValidationTestCase):
    def run_test(self):
        ...
        self.expect_invalid_valueInClosure(column_name="service_id",
                                           value="WEEKDAY",
...
class TripDistanceFromStopToShapeValidationTestCase(util.ValidationTestCase):
    def run_test(self):
        ...
        stop1.stop_lat = None
        self.ValidateAndexpect_missing_value(schedule, "stop_lat")
...
class TripHasStopTimeValidationTestCase(util.ValidationTestCase):
    def run_test(self):
        ...
        self.expect_invalid_valueInClosure(
...
class AddFrequencyValidationTestCase(util.ValidationTestCase):
    def expect_invalid_value(self, start_time, end_time, headway,
                             column_name, value):
        try:
            trip = transitfeed.Trip()
    ...
    def expect_missing_value(self, start_time, end_time, headway, column_name):
        try:
            trip = transitfeed.Trip()
            trip.AddFrequency(start_time, end_time, headway)
    ...
    def run_test(self):
        ...
        self.expect_missing_value(None, 50, 1200, "start_time")
        self.expect_missing_value("", 50, 1200, "start_time")
        self.expect_invalid_value("midnight", 50, 1200, "start_time",
                                  "midnight")
        self.expect_invalid_value(-50, 50, 1200, "start_time", -50)
        self.expect_missing_value(0, None, 1200, "end_time")
        self.expect_missing_value(0, "", 1200, "end_time")
        self.expect_invalid_value(0, "noon", 1200, "end_time", "noon")
        self.expect_invalid_value(0, -50, 1200, "end_time", -50)
        self.expect_missing_value(0, 600, 0, "headway_secs")
        self.expect_missing_value(0, 600, None, "headway_secs")
        self.expect_missing_value(0, 600, "", "headway_secs")
        self.expect_invalid_value(0, 600, "test", "headway_secs", "test")
        self.expect_invalid_value(0, 600, -60, "headway_secs", -60)
        self.expect_invalid_value(0, 0, 1200, "end_time", 0)
        self.expect_invalid_value("12:00:00", "06:00:00", 1200, "end_time",
                                  21600)
...
class GetTripTimeTestCase(util.TestCase):
    ...
    def test_get_time_interpolated_stops(self):
    ...
    def test_get_time_interpolated_stopsSingleStopTime(self):
        self.trip3.AddStopTime(self.stop3, schedule=self.schedule,
                               departure_secs=500, arrival_secs=500)
    ...
    def test_get_stop_time_trips(self):
...
class GetFrequencyTimesTestCase(util.TestCase):
    ...
    def test_get_frequency_start_times(self):
    ...
    def test_get_frequency_stop_times(self):
