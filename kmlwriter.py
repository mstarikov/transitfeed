...
class KMLwriter(object):
    ...
    def _create_folder(self, parent, name, visible=True, description=None):
    ...
    def _create_style_for_route(self, doc, route):
    ...
    def _create_placemark(self, parent, name, style_id=None, visible=True,
                          description=None):
    ...
    def _create_line_string(self, parent, coordinate_list):
    ...
    def _stopfolder_selection_method(self, stop_folder):
    ...
    def _stopstyle_selection_method(self, doc):
    ...
    def _create_style(self, doc, style_id, style_dict):
    ...
    def _create_route_patterns_folder(self, parent, route,
    ...
    def _create_route_shapes_folder(self, schedule, parent, route,
                                    style_id=None, visible=True):
        ...
        for shape_id, trips in shape_id_to_trips_items:
            ...
            placemark = self._create_placemark(folder, name, style_id, visible,
                                               description)
            self._create_line_string_for_shape(placemark, schedule.GetShape(shape_id))
        return folder
    ...
    def _create_route_trips_folder(self, parent, route, style_id=None, schedule=None):
        ...
        for trip in trips:
            ...
            placemark = self._create_placemark(trips_folder,
                                               trip.trip_id,
                                               style_id=style_id,
                                               visible=False,
                                               description=description)
